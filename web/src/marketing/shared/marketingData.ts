...
export const TESTIMONIALS = [
  {
    quote:
      "I've always had photos everywhere, but Travel Diaries finally gives my trips a story.",
    name: "Demo Traveler",
    seed: "traveler1",
  },
  {
...
export const FAQ_ITEMS = [
  {
    q: "What is Travel Diaries?",
    a: "Travel Diaries is a personal travel memory and journey platform — a map-first place to track everywhere you've been, save memories, and plan where you're going next.",
  },
  {
    q: "Is Travel Diaries free?",
  ...
  },
  {
    ...
    a: "Absolutely. Travel Diaries tracks countries and continents alongside a dedicated India Explorer view for Indian states and union territories.",
  },
  {
  ...
  {
    q: "Does Travel Diaries work on mobile?",
    a: "Yes, Travel Diaries is fully responsive with a dedicated mobile navigation and touch-friendly map.",
  },
  {
  ...
  {
    q: "Can I use Travel Diaries for group trips?",

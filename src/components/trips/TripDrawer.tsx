...
type Tab = "overview" | "checklist" | "budget";
      ...
      >
        ...
        >
          ...
          <div className="px-5 mt-4 flex gap-1 border-b border-ink/8 dark:border-white/10">
            {(["overview", "checklist", "budget"] as Tab[]).map((t) => (
              <button
                key={t}
                onClick={() => setTab(t)}
              ...
              <div>
                {trip.checklist && trip.checklist.length > 0 ? (
                  ...
                  <p className="text-sm text-ink-soft dark:text-white/50">
                    No checklist items yet for this trip.
                  </p>
                )}
              </div>
            )}
              ...
              <div>
                {trip.budget && trip.budget.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    <Plus size={20} className="mx-auto text-ink-soft mb-2" />
                    <p className="text-sm text-ink-soft dark:text-white/50">
                      No budget tracked yet for this trip.
                    </p>
                  </div>
                )}
              </div>

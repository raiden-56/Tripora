...
function TripPlannerPanel() {
  ...
  return (
    <div className="grid lg:grid-cols-[360px_1fr] gap-6">
      ...
      <div>
        {!itinerary ? (
          <div className="h-full flex flex-col items-center justify-center text-center py-16 rounded-3xl border border-dashed border-ink/15 dark:border-white/15">
            <Sparkles size={24} className="text-forest-500 mb-3" />
            <p className="font-semibold mb-1">No itinerary yet</p>
            <p className="text-sm text-ink-soft dark:text-white/50 max-w-xs">
              Fill in your trip details and generate a full day-by-day plan.
            </p>
          </div>
        ) : (
          <motion.div
